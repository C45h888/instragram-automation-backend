// retry-cadence-kernel/workers/telemetry-retry-capability-worker.js
// Telemetry Retry Worker — namespace: capability.
// Mirrors telemetry-retry-systemic-worker.js. Drains
// lineage:projection-staging:capability and re-emits each entry through
// the canonical observability.transition() path.
    ...
    try {
      await emitter.transition({
        ...
        raw: {
          ...
          projectionType: entry.projectionType || 'CAPABILITY_PROJECTION',

// retry-cadence-kernel/workers/telemetry-retry-reconciliation-worker.js
// Telemetry Retry Worker — namespace: reconciliation.
// Drains lineage:projection-staging:reconciliation and re-emits each entry
// through the canonical observability.transition() path.

const crypto = require('crypto');
const { getRedisClient } = require('../../config/redis');

const NAMESPACE = 'reconciliation';
    ...
    try {
      await emitter.transition({
        ...
        raw: {
          ...
          projectionType: entry.projectionType || 'RECONCILIATION_PROJECTION',

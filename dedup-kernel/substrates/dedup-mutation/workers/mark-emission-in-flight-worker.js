// dedup-kernel/substrates/dedup-mutation/workers/mark-emission-in-flight-worker.js
// Mark Emission In-Flight Worker: bounded, semantically blind.
//
// Bound to: dedup-kernel/substrates/dedup-mutation/index.js
// One bounded I/O call: substrate.markInFlightEmission()
//
...
async function execute(params) {
  ...
  await substrate.markInFlightEmission(accountId, actionType, resourceId, { intentId });
}

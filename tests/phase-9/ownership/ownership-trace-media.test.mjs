...
const FIXTURE_PATH = path.join(__dirname, '..', 'fixtures', 'webhooks', 'canonical', 'media-update.json');
...
describe('ownership/ownership-trace-media', () => {
  ...
  beforeAll(async () => {
    harness = new p9.RuntimeHarness({ runId: 'p9-own-media' });
    await harness.boot();

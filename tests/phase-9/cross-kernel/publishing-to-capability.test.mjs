...
// Source: publishing  →  Sink: capability
//
// Validates: the runtime's CK routes the cross-kernel signal from
// publishing to capability constitutionally. The recorder-observer captures
...
describe('cross-kernel/publishing-to-capability', () => {
  it('routes the signal constitutionally', async () => {
    const r = await runPair({ source: 'publishing', sink: 'capability' });

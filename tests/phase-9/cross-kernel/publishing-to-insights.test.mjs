...
// Source: publishing  →  Sink: insights
//
// Validates: the runtime's CK routes the cross-kernel signal from
// publishing to insights constitutionally. The recorder-observer captures
...
describe('cross-kernel/publishing-to-insights', () => {
  it('routes the signal constitutionally', async () => {
    const r = await runPair({ source: 'publishing', sink: 'insights' });
